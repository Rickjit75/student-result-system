...
*   **Interactive Dashboard**: At-a-glance stats showing total students, class average, and pass/fail counts.
...
3.  **Repository Layer**: Interfaces with the MySQL database using JPA.
4.  **Model Layer**: Defines the data structure for Students and Subjects.
